...
static void setWeightTable(LightField &scale_lf, LightField &lf, Point4D &src, Point4D &tar, 
...
static double patch_diff(LightField &lf1, LightField &lf2, Point4D p1, 
					Point4D p2, Point4D patch_size)
{
#define LAMBDA 0  // depth weight
...
LightField *LightFieldReshuffle::directScaleLF(LightField *lf, float y_scale, float x_scale)
{
...
void LightFieldReshuffle::PatchMatchRetarget(LightField &lf, LightField &scale_lf, Map **ref_src_map, Map **ref_tar_map, int itration, int layer)
{
...
void LightFieldReshuffle::initial(LightField &lf, LightField &scale_lf, LightFieldData<float, 1> *min_table, Map **ref_map, Map **self_map)
{
...
void LightFieldReshuffle::propagate_and_randomSearch(LightField &lf, LightField &scale_lf, LightFieldData<float, 1> *&min_table, Map **self_map, int phase,
...
void LightFieldReshuffle::refine(LightField &scale_lf, LightFieldData<float, 4> &weight_table, LightFieldData<float, 1> &depth_table,
